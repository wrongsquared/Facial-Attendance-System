                      ...
                      lowAttendanceCourses.map((module) => (
                        <div key={module.module_code} className="p-4 border rounded-lg">
                          <div className="flex items-start justify-between mb-2">
                            <div>
                              <p className="font-medium">{module.module_code} - {module.module_name}
                              </p>

                              <p className="text-sm text-gray-600 mt-1">
                                <span className="font-medium">Lecturer:</span> {module.lecturer_name}
                              </p>

                              {module.lesson_type && (
                                <p className="text-sm text-gray-600 mt-1">
                                  <span className="font-medium">Type:</span> {module.lesson_type}
                                </p>
                              )}
                              {module.tutorial_group && (
                                <p className="text-sm text-gray-600">
                                  <span className="font-medium">Tutorial Groups:</span> {module.tutorial_group}
                                </p>
                              )}
                            </div>
